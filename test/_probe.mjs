...
const routes = {
  ...
  'panel/today': { today: { date: '2026-09-13', wake: '09:30', sleep: '01:10', mood: 62, battery: 64, focus: '大理攻略', events: ['周末'] }, deform: { state: 'normal', stress: 22, integration: 12, thresholds: { grip: 58, loop: 80, shadow: 95 }, enabled: true, sensitivity: 0.67 }, world: { date: '2026-09-12', forDate: '2026-09-13', diary: '周末还是没能完全躺平。', thoughts: ['想去大理'], secrets: ['存了他一句话'], npcs: [{ name: '张姐', rel: '同事', note: '爱八卦' }], flow: [{ time: '10:10', text: '赖床' }], workload: 0, tone: { intimacy: 25, reason: '刚认识' }, statusLine: '今天案子卡住了，有点闷' }, evolution: { warm: 2, rude: 0, chats: 12 }, relation: { hasOwner: true, mood: 62, chats: 12, firstSeen: now - 5 * 86400000, lastSeen: now, callsMe: '苏镜语' } },
